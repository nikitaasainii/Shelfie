function LandingPage(){
    return(
        <div className="relative flex flex-col h-screen bg-[#EDECED] items-center justify-center gap-3 ">
            ...
            <button className="bg-white text-[#FF1FA9] rounded-full border-1 border-[#FF1FA9] w-60 h-15 hover:scale-105 hover:bg-[#FF1FA9] hover:text-white active:scale-95 transition-all duration-200">Register</button>
            <button className="bg-white text-[#FF1FA9] rounded-full border-1 border-[#FF1FA9] w-60 h-15 hover:scale-105 hover:bg-[#FF1FA9] hover:text-white active:scale-95 transition-all duration-200">Login</button>
            </div>
