...
function LandingPage(){
    ...
    return(
        <div className="relative flex flex-col h-screen bg-[#EDECED] items-center justify-center gap-3 ">
            <img src="/icons.png" className="absolute -top-30 left-0 w-64 h-auto" />
            ...
            <img src="/icon_design.png" className="absolute -top-30 right-0 w-64 h-auto" />
        ...
        <div className="absolute bottom-0 bg-[#F48AAE] h-10 w-full whitespace-nowrap"></div>
        </div>
    )
}
