...
function RegisterPage(){
    ...
    return(
        <div className="relative flex flex-col h-screen bg-[#EDECED] items-center justify-center gap-3 ">
            ...
            <div className="bg-white rounded-3xl p-6 h-80 w-100 flex flex-col gap-2">
                <label htmlFor="" className="font-['Times_New_Roman_MT_Condensed',_serif] text-[#FF1FA9] text-2xl">Name</label>
            ...
            <button className="bg-white text-[#FF1FA9] rounded-full border-1 border-[#FF1FA9] w-60 h-15 hover:scale-105 hover:bg-[#FF1FA9] hover:text-white active:scale-95 transition-all duration-200" onClick={()=>navigate('/shelf')}>Register</button>
            </div>
