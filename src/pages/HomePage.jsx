...
function HomePage(){
    return(
        <div className="relative flex flex-col h-screen overflow-hidden bg-[#EDECED]">
        ...
        <div className="flex flex-col h-screen">
            ...
            <div className="absolute bottom-0 w-full translate-y-1/2 px-70 flex justify-between">
                <button className="bg-white text-[#FF1FA9] rounded-full border-1 border-[#FF1FA9] w-60 h-15 ">Add Book +</button>
            ...
            <div className="bottom-0 bg-[#FF1FA9] h-25 w-full overflow-hidden whitespace-nowrap">
